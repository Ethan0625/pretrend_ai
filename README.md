...
* [ ] Macro Silver Feature 단위테스트 (`tests/pipeline/test_macro_features.py`)
* [ ] Airflow DAG → Macro Ingest + Silver Feature 파이프라인 구성
* [ ] EOD/뉴스/섹터 테마 데이터 파이프라인 확장
* [ ] 전략/신호 생성 모듈 개발 (Pre-Trend Value 스코어링)
