...
| P-104 | 2026-05-27 | Regime Similarity | Medium | Resolved | Gold/EOD freshness는 최신인데 `similarity_regime`만 과거 날짜에 머묾 | regime similarity source가 Observability 독립 builder가 아니라 legacy `strategy_job` snapshot에 의존 | P34 Gold DB 기반 regime feature builder + DAG source contract test | [P-104](./incidents/P-104-regime-snapshot-dependency.md) |
