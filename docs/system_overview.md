...
- **전략 아키텍처 상세**: [`docs/strategy_architecture.md`](strategy_architecture.md)
- **전체 아키텍처**: [`docs/architecture.md`](architecture.md)
- **전략 엔진 SOT**: [`docs/strategy_engine_design.md`](strategy_engine_design.md)
- **운영 가이드**: [`docs/operation_guide.md`](operation_guide.md)
- **마일스톤**: [`docs/milestones.md`](milestones.md)
