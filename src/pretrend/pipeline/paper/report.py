...
def build_paper_result_payload(
    *,
    ...
    broker_balance_currency: Optional[str] = None,
    broker_positions: Optional[List[Dict[str, Any]]] = None,
    broker_fx_usdkrw: Optional[float] = None,
    ...
    payload: Dict[str, Any] = {
        ...
        "broker_fx_usdkrw": (None if broker_fx_usdkrw is None else float(broker_fx_usdkrw)),
